    ...
    <div className="min-h-screen flex bg-[#0a0a0a] text-white">
      ...
      <div className="hidden md:flex w-1/2 flex-col justify-center px-16 bg-gradient-to-br from-yellow-500/10 to-transparent">
        <h1 className="text-5xl font-bold leading-tight">
          Start Your <br />
          <span className="text-yellow-400">DSA Journey 🚀</span>
        </h1>

        <p className="text-gray-400 mt-6 max-w-md">
          Join thousands of learners mastering Data Structures &
          Algorithms step by step.
        </p>

        <div className="mt-10 space-y-3 text-sm text-gray-500">
          <p>✔ Structured roadmap</p>
          <p>✔ Real coding problems</p>
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full mt-2 p-3 rounded-lg bg-[#1a1a1a] border border-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500"
                />
              </div>
